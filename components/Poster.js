...
function Poster({ track, chooseTrack }) {
  ...
  return (
    <div
      className=" flex-none w-[250px] h-[250px] rounded-[30px] overflow-hidden relative text-white/80 cursor-pointer hover:scale-105 hover:text-white/100 transition duration-200 ease-out group mx-auto"
      onClick={handlePlay}
    >
      <img
        src={track.albumUrl}
